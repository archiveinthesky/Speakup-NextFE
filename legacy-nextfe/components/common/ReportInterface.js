                ...
                >
                    <ul>
                        {displayOptions.map((option, i) => (
                            <li
                                key={i}
                                className="my-4 list-none text-xl text-neutral-700"
                            >
                                <input
                                    type="radio"
                                    name="reason"
                    ...
                    {submitted ? (
                        <button
                            className="mt-6 h-10 w-16 rounded-lg bg-primary-700 text-sm text-white"
                            onClick={closeFunction}
                        >
                            關閉
                        </button>
                        ...
                        <button
                            type="submit"
                            className="h-10 w-16 rounded-lg bg-primary-700 text-sm text-white disabled:opacity-75"
