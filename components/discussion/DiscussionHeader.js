    ...
    if (router.isFallback) {
        ...
        return (
            <div className="mx-auto w-full bg-neutral-50 px-9 py-6">
                <h1 className="pb-2 text-3xl text-neutral-800">{pagedata.title}</h1>
                <div className="pb-3">
                    <img className="mr-3 inline h-5 w-5" src={pagedata.authorPfp} alt=""></img>
                ...
                <div className="mt-6 flex flex-col gap-5">
                    <p className="text-lg text-neutral-700">{pagedata.content}</p>

                    <div>
                        {showStandpoint && (
                            <div>
                                <p className="text-primary-600 mb-2 text-xl">支持者的立場</p>
                                <p className="mb-5 text-lg text-neutral-700">
                                    {pagedata.supContent}
                                </p>
                                <p className="text-primary-600 mb-2 text-xl">反對者的立場</p>
                                <p className="text-lg text-neutral-700">{pagedata.agnContent}</p>
                            </div>
                        )}
                        <button
                            onClick={() => {
                        ...
                        >
                            <p className="text-primary-600 text-left text-lg leading-10">
                    ...
                    <div>
                        {showReference && (
                            <div>
                                <p className="text-primary-600 mb-2 text-xl">延伸資料</p>
                    ...
                    <div className="flex h-8 justify-start">
                        <button onClick={toggleSaved}>
                            <BookmarkIcon
                                className={`text-primary-600 h-8 w-8 transition-colors ${
