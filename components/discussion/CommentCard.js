...
const CommentCard = forwardRef(
    (
        ...
        const deleteComment = () => {
            let onside = ["sup", "all", "agn"][onSide];
            fetch(
                `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/comments/delete/${boardId}/${onside}${
                    motherComment !== null ? "/" + motherComment : ""
                }/${cmtdata.id}`,
                {
                    method: "DELETE",
                ...
                >
                    <div
                        ...
                        style={{
                            ...
                            right:
                                window.innerWidth - cardmenu.current.getBoundingClientRect().x - 15,
                        }}
                    >
                        <button
            ...
            <>
                <div className="flex w-full gap-3" ref={ref}>
                    ...
                    <div className="flex-grow">
                        ...
                        <p className="mt-2 mb-3 text-base text-neutral-600">{cmtdata.cmtContent}</p>
