        ...
        <div className="fixed top-0 left-0 z-30 flex h-screen w-screen items-center justify-center">
            ...
            <div className="z-40 w-5/6 max-w-[24rem] rounded-2xl bg-neutral-50 p-6 ">
                ...
                >
                    ...
                    {submitted ? (
                        <button
                            className="bg-primary-500 mt-6 h-10 w-16 rounded-lg text-sm text-white"
                            onClick={closeFunction}
                        >
                            關閉
                        </button>
                        ...
                        <button
                            type="submit"
                            className="bg-primary-500 h-10 w-16 rounded-lg text-sm text-white disabled:opacity-75"
